...
legal-vote-overview-panel-status-finished = Fertig
...
legal-vote-success = Ihre Stimme wurde erfolgreich gezählt
...
dashboard-meeting-card-title-next-meetings = Geplante Meetings
...
whiteboard-start-whiteboard-button = Whiteboard starten
whiteboard-new-whiteboard-message = Es ist ein Whiteboard verfügbar
