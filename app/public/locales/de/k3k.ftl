...
joinform-enter-password = Passwort
...
dashboard-meeting-card-button-start-direct = Starten
...
dashboard-plan-new-meeting = Planen
dashboard-join-meeting-button = Beitreten
...
dashboard-direct-meeting-password-placeholder = Bitte Meetingpasswort definieren
...
glitchtip-crash-report-labelComments = Was ist passiert? Bitte erläutern Sie ( Schritt für Schritt, gern in kurzen Stichpunkten formuliert. )
